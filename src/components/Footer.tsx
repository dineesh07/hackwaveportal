        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.topRight}>
            <nav className={styles.navLinks}>
              ...
              <Link href="/#timeline" className={styles.navLink} style={{ '--stagger': 4 } as React.CSSProperties}>Timeline</Link>
              <Link href="/#mentors" className={styles.navLink} style={{ '--stagger': 5 } as React.CSSProperties}>Mentors</Link>
              <Link href="/#faq" className={styles.navLink} style={{ '--stagger': 6 } as React.CSSProperties}>FAQ</Link>
              <Link href="/register" className={styles.navLink} style={{ '--stagger': 7 } as React.CSSProperties}>Register</Link>
              <Link href="/login" className={styles.navLink} style={{ '--stagger': 8 } as React.CSSProperties}>Login</Link>
            </nav>
          </div>
        </div>
