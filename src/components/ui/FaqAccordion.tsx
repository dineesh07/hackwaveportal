...
const faqs = [
  ...
  { q: "When will the Problem Statements be released?", a: "The official Problem Statements will be released on 7th August, alongside the opening of registrations. Teams can then select a problem statement, brainstorm ideas, and begin developing their solution." },
